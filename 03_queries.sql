...
UPDATE patients 
SET phone = '+49-176-99998888', address = 'New Address 45, Berlin' 
WHERE patient_id = 1;

UPDATE appointments 
SET status = 'cancelled', notes = 'Patient requested cancellation' 
WHERE appointment_id = 1;



DELETE FROM prescriptions WHERE prescription_id = 5;


DELETE FROM appointments WHERE status = 'cancelled' AND scheduled_at < '2024-01-01';
